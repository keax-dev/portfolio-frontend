...
describe('NotificationService', () => {
  ...
  // Caso: adds notifications with increasing identifiers.
  ...
  // Caso: dismisses a notification explicitly.
  ...
  // Caso: automatically dismisses a notification after five seconds.
